                    ...
                    <form action="/save" method="post">
                        ...
                        <div class="pt-5 pb-5">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" placeholder="Enter title or typography logo" name="title"> 
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="number" class="form-control form-control-lg" id="email" placeholder="Enter your number" name="phone"> 
                        ...
                        <div class="mt-5">
                            <p>Your profile link is : <span>localhost:8000/templates/portfolio/home</span></p>
                        </div>
