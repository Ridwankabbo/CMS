...
<!-- Home Section -->
    <section id="home" class="page-section active-section bg-gradient-to-r from-blue-500 to-purple-600 text-white flex items-center justify-center text-center p-8 md:p-16">
        <div class="max-w-4xl">
            ...
            <h1 class="text-4xl md:text-5xl font-extrabold mb-4 animate-fade-in-down">{{$userPortfolio->title}}</h1>
            <p class="text-xl md:text-2xl font-light mb-8 animate-fade-in-up">{{$userPortfolio->intro_text}} </p>
